                        ...
                        .map((item) => (
                            <tr key={item.id} className="border-t-1 border-[#D9D9D9]">
                                            ...
                                            {item.productDiscountAmount ? (
                                                <div className="flex flex-row gap-1 items-center">
                                                    <div className=" bg-red-500 text-white px-3 py-1 rounded-md font-semibold text-xs">
                                                        ลด{" "}
                                                        {((item.productDiscountAmount / item.price) * 100).toFixed(0)}%
                                                    </div>
                                                    <p className="text-sm font-semibold">
                                                        ฿
                                                        {(item.price - item.productDiscountAmount).toLocaleString(
                                                            "en-US"
                                                        )}
                                                    </p>
                                ...
                                <td className="px-6 py-4 text-xl">
                                    ฿
                                    {((item.price - item.productDiscountAmount) * item.quantity).toLocaleString(
                                        "en-US"
                                    )}
                                </td>
