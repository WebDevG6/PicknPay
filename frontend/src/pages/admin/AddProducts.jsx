    ...
    return (
        <div className="rounded-lg shadow-lg mx-8 my-4 p-8 bg-white">
            <Form layout="vertical" requiredMark={false}>
                ...
                <Form.Item label="แบรนด์" rules={[{ message: "กรุณาเลือกแบรนด์" }]}>
                    <Select
                ...
                <Form.Item label="จำนวนคงเหลือ(สต็อก)" rules={[{ message: "กรุณากรอกจำนวนสินค้าคงเหลือ" }]}>
                ...
                <Form.Item label="รายละเอียดสินค้า" rules={[{ message: "กรุณากรอกรายละเอียดสินค้า" }]}>
