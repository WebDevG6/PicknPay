    ...
    return (
        <div className="rounded-lg shadow-lg mx-8 my-4 p-8 bg-white">
            <Form layout="vertical">
                <Form.Item label="ชื่อสินค้า" rules={[{ message: "กรุณากรอกชื่อสินค้า", required: false }]}>
                    <Input placeholder="ระบุชื่อสินค้า" maxLength={1000} value={formData.name} onChange={(e) => handleChange("name", e.target.value)} />
                </Form.Item>

                <Form.Item label="ราคา" rules={[{ message: "กรุณากรอกราคา", required: false }]}>
                ...
                <Form.Item label="แบรนด์" rules={[{ message: "กรุณาเลือกแบรนด์", required: false }]}>
                    <Select
                ...
                <Form.Item label="จำนวนคงเหลือ(สต็อก)" rules={[{ message: "กรุณากรอกจำนวนสินค้าคงเหลือ", required: false }]}>
                ...
                <Form.Item label="รายละเอียดสินค้า" rules={[{ message: "กรุณากรอกรายละเอียดสินค้า", required: false }]}>
